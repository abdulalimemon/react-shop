...
const NotFound = () => {
    return (
        <section className="flex items-center h-full p-16 accent">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center">
                    ...
                    <p className="mt-4 mb-8 primary-text">But dont worry, you can find plenty of other things on our homepage.</p>
